...
namespace our {
    ...
    public:
        ...
        // Ans: Cause the classes manages the shader program which is a resource related to OpenGL
        // and we don't want to copy it, which leads of having multiple instances of the same shader program in
        // different objects
