...
namespace our {
    ...
    // we will encapsulate all these options into a single structure that will also be responsible for configuring
    // OpenGL's pipeline
    struct PipelineState {
        ...
        // This set of pipeline options specifies whether depth testing will be used or not and how it will be
        // configured
        struct {
            bool enabled = false;
