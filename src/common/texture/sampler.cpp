...
namespace our {
    ...
    void Sampler::deserialize(const nlohmann::json& data) {
        ...
        set(GL_TEXTURE_MAG_FILTER,
            (GLint)gl_enum_deserialize::texture_magnification_filters.at(data.value("MAG_FILTER", "GL_LINEAR")));
        set(GL_TEXTURE_MIN_FILTER, (GLint)gl_enum_deserialize::texture_minification_filters.at(
                                       data.value("MIN_FILTER", "GL_LINEAR_MIPMAP_LINEAR")));
